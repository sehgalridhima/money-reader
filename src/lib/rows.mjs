/* ===============================================================
   ...
   This file does not import pdf.js. It is handed a `getDocument`,
   because the same logic has to run in two places that resolve that
   import differently: Node wants the legacy build, the browser wants
   the regular one with a worker. One copy of the row grouping, two
   thin wrappers — see pdf-node.mjs and pdf-browser.mjs.
   =============================================================== */
 ...
 */
export async function readRowsWith(getDocument, data, password, extra = {}) {
